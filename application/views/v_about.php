...
<html class="no-js"> <!--<![endif]-->
	...
	<meta name="author" content="Bayu Ihsanudin" />
	...
	<header id="fh5co-header" role="banner">
		<div class="container">
			<div class="header-inner">
				<h1><a href="<?php echo base_url().''?>">CREATIVEGEEK<span>.</span></a></h1>
				<nav role="navigation">
					<ul>
		   		...
		   		<div class="container">
		   			<div class="col-md-10 col-md-offset-1 text-center js-fullheight slider-text">
		   				<div class="slider-text-inner">
		   					<h2>Who We Are</h2>
		   					<p class="fh5co-lead"> CreativeGeek</p>
		   				</div>
		   			</div>
		   		</div>
		   	</li>
	...
	<div class="fh5co-about animate-box">
		<div class="col-md-6 col-md-offset-3 text-center fh5co-heading">
			<h2>About Us</h2>
			<p>CreativeGeek merupakan perusahaan yang bergerak dan memfokuskan diri pada bidang Konsultan IT dan Security. Seiring dengan pesatnya perkembangan teknologi dan keterkaitan nya dengan bidang usaha maka kami hadir di dunia teknologi informasi untuk memberikan solusi, perencanaan, dan strategi yang terintegerasi sebagai nilai tambah yang maksimal bagi kebutuhan dan permasalahan dibidang Teknologi Informasi.</p>
		</div>
		<div class="container">
			<div class="col-md-6">
				<figure>
		...
		<div class="container">
				...
				<div class="row">
					...
					<div class="col-md-4 fh5co-staff">
						...
						<p>Azrul Tjan adalah seorang Video & Graphic Designer lulusan perguruan tinggi di daerah Bandung.</p>
					...
					<div class="col-md-4 fh5co-staff">
						...
						<h3>Bayu Ihsanudin</h3>
						<h4>Banker</h4>
						<p>Bayu Ihsanudin adalah seorang Banker lulusan perguruan tinggi di daerah Bandung.</p>
						<ul class="fh5co-social">
							<li><a href="#"><i class="icon-google"></i></a></li>
							<li><a href="#"><i class="icon-dribbble"></i></a></li>
							<li><a href="#"><i class="icon-twitter"></i></a></li>
